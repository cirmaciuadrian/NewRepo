        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Detail = table.Column<string>(type: "varchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseCases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseCases_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseExplanations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseExplanations_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SolutionValue = table.Column<string>(type: "varchar(255)", nullable: true),
                    ExerciseId = table.Column<int>(type: "int", nullable: false),
                    ExerciseCaseId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseCases_ExerciseId",
                table: "ExerciseCases",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_ExerciseExplanations_ExerciseId",
                table: "ExerciseExplanations",
                column: "ExerciseId");
